...
// Usage:
//
//	omega ask "question" [--stream] [--session N] [--max-steps N] [--json]
//	omega skills list [--json]
//	omega skills describe NAME [--json]
//	omega skills run NAME [--arg key=value ...] [--json]
//	omega memory search "query" [-k N] [--json]
//	omega memory add "text" [--meta key=value ...] [--json]
//	omega memory list [-limit N] [-offset N] [--json]
//	omega memory delete ID [--json]
//	omega schedule list [--json]
//	omega schedule create --name X --cron "..." --skill Y [--arg key=value ...] [--one-shot]
...
// to a gateway base URL to hit a running gateway over HTTP instead.
package main
...
Usage:
  ...
  omega memory delete ID [--json]
  omega schedule list [--json]
  omega schedule create --name NAME --cron EXPR --skill SKILL [--arg k=v ...] [--one-shot]
  omega schedule delete ID
  omega session list [--json]
  omega session export ID
